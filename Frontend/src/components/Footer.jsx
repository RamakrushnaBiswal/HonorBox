...
// 1. Import useEffect to fetch data
...
const Footer = () => {
  ...
  // 2. Add state to store the visitor count
  const [visitorCount, setVisitorCount] = useState(null);

  // 3. Use useEffect to fetch the visitor count when the component mounts
  useEffect(() => {
    const fetchVisitorCount = async () => {
      try {
        // This endpoint proxies to your backend via the vite.config.js setup
        ...
        // Set a default or error state if needed
        setVisitorCount('N/A');
      }
    };
    ...
    >
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center text-center relative z-10">
          ...
          {/* Right Section - Copyright & Visitor Count */}
          <motion.div
          ...
          >
            ...
            {/* 4. Display the visitor count here */}
            <motion.span
